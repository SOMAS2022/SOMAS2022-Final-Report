...
class Game:
    ...
    def __init__(self, 
        ...
        ---------
        peasants: list
            the peasants to play the game
        reward_scheme: str
            how to distribute experience; choices include "uniform", 
            "combat-proportional", and "socially-consicous"
        round_limit: int
            how many rounds after which to end the game
        monster_base_level: int
            how strong the monster is, at the start of the game
        monster_level_factor: float
            how much the monster's level increases between rounds
        reward_weights: tuple
            the weights used to balance experience distribution in 
            a socially conscious reward scheme
        """
    ...
    def distribute_experience(self, peasants: list, experience: float):
        """ Hands out experience to the peasants according to the game's 
        reward scheme 
        """
