...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\linewidth]{SOMAS-Agent2-Report/Resources/process.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{SOMAS-Agent2-Report/Resources/fightaction.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\linewidth]{SOMAS-Agent2-Report/Resources/lootAllocation.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\linewidth]{SOMAS-Agent2-Report/Resources/handleUpdate.png}
