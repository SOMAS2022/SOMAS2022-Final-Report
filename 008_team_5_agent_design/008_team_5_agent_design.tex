...
\begin{itemize}
    ...
    \item Term Length
          \begin{itemize}
              \item 1 level if haven't been elected before
              \item $N$ levels if running the $N$th leader term
...
\begin{figure*}[h]
    \subfloat[]{%
        \includegraphics[width=.5\linewidth]{008_team_5_agent_design/images/level2.png}%
        \label{subfig:a}%
    }\hfill
    \subfloat[]{%
        \includegraphics[width=.5\linewidth]{008_team_5_agent_design/images/level20.png}%
        \label{subfig:b}%
    }\\
    \subfloat[]{%
        \includegraphics[width=.5\linewidth]{008_team_5_agent_design/images/level25.png}%
        \label{subfig:c}%
    }\hfill
    \subfloat[]{%
        \includegraphics[width=.5\linewidth]{008_team_5_agent_design/images/level33.png}%
        \label{subfig:d}%
    }
    \caption{Agents' trust score at different levels, with strategy and goodwill personality boundaries both at 0.2 and 0.8, 30 of each type of agents are instantiate}
